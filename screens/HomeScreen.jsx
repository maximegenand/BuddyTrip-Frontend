...
export default function HomeScreen({ navigation }) {
  ...
  const tripList = trips.map((trip) => {
    ...
    const isScreenMonth = isSameMonth(
    ...
    const titleMonth = !isScreenMonth ? (
      <View key={trip.dateStart} style={styles.monthContainer}>
        ...
        <Text style={styles.monthText}>
          {format(new Date(trip.dateStart), 'MMMM yyyy', { locale: fr })}
        </Text>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            navigation.navigate('TabNavigator', {
              screen: 'Trip',
              params: { tokenTrip: trip.tokenTrip },
            })
          }
        >
          ...
          <View style={styles.content}>
            {
              ...
              tripList.length ? (
                ...
                <Text style={styles.noTrip}>Aucun Trip renseigné</Text>
              )
            }
          </View>
        </ScrollView>
